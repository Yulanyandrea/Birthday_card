...
const Pictures = () => {
  return (
    <div className="years">
      <p className="years__text">
        Han pasado 7 años o más o menos ya no recuerdo jeje desde que nos
        conocimos. Y como bien sabes es una amistad que quiero conservar por el
        resto de mis dias puesto que siempre has sido un gran
        amigo y apoyo en mis dias felices y en los más oscuros tambien, por lo
        tanto mi unica forma de celebrar contigo tu cumpleaños en este momento
        es de esta forma. Desde la distancia te mando un millon de abrazos y
        muchos deseos de los buenos para el año nuevo que empieza para ti . Este
        año que empieza estará cargado de mucha felicidad y de amor de todo tipo{" "}
      </p>
      <h2 className="years__paragraph">
        Te quiero con todo mi corazón hoy y siempre
      </h2>
      <h1 className="years__hb">Feliz Cumpleaños</h1>

      <section className="years__animation">
        <div class="container">
          <svg
            data-name="Layer 1"
      ...
      <section className="years__pictures">
        <img id="mom" src="/images/mom.jpg" alt="" />
        <img id="fight" src="/images/fight.jpg" alt="" />
        <img id="nepal" src="/images/nepal.jpg" alt="" />
        <p className="years__description"> Que celebres junto a tu familia, que sigas peliando
        contra los villanos en cualquier parte del mundo y que sigas teniendo aventuras con el
        canguro/zorro Nepali/Canadiense  y que este 2023 sea el año en que nos volvamos a ver !!! </p>
      </section>
    </div>
  );
};
